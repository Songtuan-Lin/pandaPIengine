...
namespace progression {
    void computeEffectsAndPreconditions(Model* model, vector<int>* poss_eff_positive, vector<int>* poss_eff_negative,
        ...
        poss_eff_positive = new vector<int>[amount_compound_tasks];
        poss_eff_negative = new vector<int>[amount_compound_tasks];
        eff_positive = new vector<int>[amount_compound_tasks];
        eff_negative = new vector<int>[amount_compound_tasks];
        preconditions = new vector<int>[amount_compound_tasks];

        model->poss_pos_m = new vector<int>[model->numMethods];
        model->poss_neg_m = new vector<int>[model->numMethods];
        model->eff_pos_m = new vector<int>[model->numMethods];
        model->eff_neg_m = new vector<int>[model->numMethods];
        model->prec_m = new vector<int>[model->numMethods];
        long startT=0;
        timeval tp;
